...
<Callout type="warn" title="Getting 'Author identity unknown' errors?">
If git or lazygit complains about unknown author identity, you need to set your global Git name and email first. See the [Git identity setup](/docs/installation#git-identity) in the installation guide, or run:
```sh
